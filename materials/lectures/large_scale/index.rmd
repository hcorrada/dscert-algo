...
.column[Our goal is then to find the value of $\beta_1$ that minimizes mean squared error. This corresponds to finding one of these many possible lines:]
...
$$\frac{\partial}{\partial \beta_{1}} L(\beta_1) = \\
\frac{\partial}{\partial \beta_{1}} \frac{1}{2} \sum_{i=1}^n (y_i - \beta_1 x_i)^2 \\
...
"Batch" gradient descent: take a step (update $\beta_1$) by calculating derivative with respect to _all_ $n$ observations in our dataset. 
